...
public class OverviewContractPanel extends JPanel implements IntContractMgmt {
	...
	private JButton newCustomerBtn, deleteContractBtn, overviewBtn, newContractBtn;
	...
	public OverviewContractPanel(HaseGmbHManagement driver) {
		...
		deleteContractBtn = new JButton("Auftrag löschen");
		deleteContractBtn.setBounds(43, 80, 200, 23);
		add(deleteContractBtn);
		...
		deleteContractBtn.addActionListener(l -> {

			String selectedContractString = list.getSelectedValue();
			int contractID = Integer.parseInt(selectedContractString);
			Contract contract = getContract(contractID);
			new DeleteContract(driver, contract).setVisible(true);
